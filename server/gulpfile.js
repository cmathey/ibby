...
const TS_COMMON_SRC_GLOB = "../common/**/*.ts";
const TS_TEST_GLOB = "./test/**/*.ts";
const JS_TEST_GLOB = "./build/test/**/*.js";
const JS_SRC_GLOB = "./build/src/**/*.js";
const TS_GLOB = [TS_SRC_GLOB, TS_COMMON_SRC_GLOB, TS_TEST_GLOB];
...
gulp.task("start-js", [BUILD], function() {
    return nodemon({
        ext: "ts js json",
...
gulp.task('start', () => nodemon({
    ...
    args:['--port=5000'],
    nodeArgs: ['-r', 'ts-node/register', '--inspect=9222'],
    watch: ['src/*'],
    ext: 'ts js json',
    env: {
        'NODE_ENV': 'development'
